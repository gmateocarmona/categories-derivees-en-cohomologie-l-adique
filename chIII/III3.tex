...
\vskip .3cm
Preuve~: On peut supposer que $E$ est un $\mathbf{Q}_\ell$-faisceau constructible, et alors l'assertion n'est autre que (SGA5 XV 3.2).
\vskip .3cm
{
...
\vskip .3cm
Preuve~: Le second membre a un sens d'après (3.3). Posons $S = \Spec \mathbf{F}_p$ et $\D_S = \bRd {\cHom}_{\mathbf{Q}_\ell}(. , \mathbf{Q}_\ell)$. D'après (2.3.2 a)), on a 
$$
