...
$$
\bHom_1(\mathbf{N}^\circ, A-\Mod_X), \quad \text{comme suit}.
$$
\begin{itemize}
...
$$
q: \bHom(\mathbf{N}^\circ, A-\Mod_X) \to \bHom_1(\mathbf{N}^\circ, A-\Mod_X),
$$
...
$$
\mathscr{E}_1(X, J) \to \bHom_1(\mathbf{N}^\circ, A-\Mod_X)
$$
est exact
\vskip .3cm
...
$$
\rho: \bHom_1(\mathbf{N}^\circ, A-\Mod_X) \to \Pro(A-\Mod_X),
$$
d'où un foncteur
$$
