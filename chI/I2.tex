...
Il est clair que la catégorie $\mathscr{E}_1(X, J)$ s'identifie à la sous-catégorie pleine de $\underline{\Hom}_1(\mathbf{N}^\circ, A-\Mod_X)$ engendrée pas les $A$-faisceaux, et que le diagramme
\[\begin{tikzcd}
...
\vskip .3cm
Preuve~: Il suffit de le voir pour $\rho$. Dans ce cas, la seule assertion non tautologique est que $\rho$ est pleinement fidèle. Soient donc $P$ et $Q$ deux objets de $\underline{\Hom}(\mathbf{N}^\circ, A-\Mod_X)$, et montrons que l'application canonique
$$
