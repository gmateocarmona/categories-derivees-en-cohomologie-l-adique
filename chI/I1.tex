...
\vskip .3cm
Preuve~: L'assertion (i) est immédiate. On en déduit (ii) en l'appliquant successivement à $\text{Im}(v \circ u)$ et à $\Ker(v)/\text{Im}(u)$. L'assertion (iii) est un cas particulier de (ii). Enfin (iv) s'obtient en appliquant (i) à $\text{Im}(v-u)$.
\vskip .3cm
{
...
\vskip .3cm
Preuve~: Appliquer 1.7 (i) au topos $\mathbf{T}'$.
\vskip .3cm
{
